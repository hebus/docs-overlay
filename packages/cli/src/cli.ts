...
materialize
  ...
  --mark-changed <class>     class for sidebar entries a version changes
                             (both reach authored entries only; the manifest carries the same
                              two sets so a sidebarItemsGenerator can mark autogenerated ones)
  ...
  switch (parsed.command) {
    case "materialize":
      return materializeCommand({
        ...
        markAdded: stringFlag(parsed.flags, "mark-added"),
        markChanged: stringFlag(parsed.flags, "mark-changed"),
